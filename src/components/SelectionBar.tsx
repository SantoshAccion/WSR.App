                ...
                <Grid item xs={5}>
                    ...
                    <Box sx={{ flexGrow: 1,marginTop:'10px', display: {md: 'flex' }}} id="selection-box"> 
                      ...
                      <Stack spacing={2} direction="row">
                        <Button className={classes.mystyle} sx={{textTransform:'capitalize'}} variant="contained">Add Quote</Button>
                        <Button className={classes.mystyle} sx={{marginLeft:'0px !important',textTransform:'capitalize'}} variant="outlined">Save File</Button>
                      </Stack>
                    </Box>
                </Grid>
                ...
                <Grid item xs={4}>
                    ...
                    <Box sx={{ flexGrow: 1,marginTop:'10px', display: {md: 'flex' }}} id="selection-box"> 
                      <Stack spacing={2} direction="row">
                        ...
                        <Button className={classes.mystyle} sx={{marginLeft:'0px !important',textTransform:'capitalize'}} variant="outlined">Enter Acres</Button>
